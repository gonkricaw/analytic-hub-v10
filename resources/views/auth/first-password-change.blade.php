...
<div class="auth-container">
    <div class="auth-card">
        ...
        <form method="POST" action="{{ route('password.first-change.update') }}" class="auth-form" id="passwordChangeForm">
            @csrf
        ...
        <div class="auth-footer">
            <div class="security-notice">
                <i class="fas fa-shield-alt"></i>
                <strong>Security Notice:</strong> Your password will expire in 90 days. You'll receive a reminder before it expires.
            </div>
        </div>
    </div>
</div>
